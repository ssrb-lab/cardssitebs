    ...
    return (
      <div className="text-center py-20 text-neutral-500">
        ...
        <button
          ...
          className="px-4 py-2 bg-neutral-800 rounded-xl hover:bg-neutral-700 text-white transition-colors"
        >
          Спробувати ще раз
        </button>
      </div>
    ...
    <div className="max-w-3xl mx-auto pb-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-3xl overflow-hidden shadow-xl">
        {filteredLeaders.map((leader) => {
          ...
          const isUserPremium =
            leader.isPremium && leader.premiumUntil && new Date(leader.premiumUntil) > new Date();
              ...
              <div className="flex items-center gap-2 sm:gap-4 overflow-hidden">
                ...
                <div className="min-w-0 flex-1">
                  <div className="font-bold text-white flex items-center gap-1 sm:gap-2 text-sm sm:text-lg">
                    ...
                    <span
                      className="bg-red-900/40 text-red-400 text-[10px] sm:text-xs px-1 sm:px-2 py-0.5 rounded-lg border border-red-800 flex items-center gap-1 shrink-0"
