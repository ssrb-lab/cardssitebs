      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto items-center">
          ...
          >
            <RefreshCw
              size={20}
              className={`text-neutral-400 group-hover:text-blue-400 ${isRefreshing ? 'animate-spin text-blue-400' : ''}`}
            />
            <span className="sm:hidden text-sm font-bold text-neutral-400 group-hover:text-white">
              Оновити
            </span>
          </button>
        </div>
