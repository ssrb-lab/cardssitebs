        ...
        <div className="bg-gradient-to-br from-pink-500/20 to-purple-500/20 p-6 sm:p-8 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="text-neutral-300 text-sm sm:text-base leading-relaxed mb-6">
              Тобі подобається наша гра? Твій донат — це не просто підтримка, а реальна можливість для нас оплачувати хостинг та зберігати мотивацію для подальшого розвитку проєкту. Будь-яка сума важлива! ❤️
            </p>
