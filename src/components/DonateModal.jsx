        ...
        <div className="bg-gradient-to-br from-pink-500/20 to-purple-500/20 p-6 sm:p-8 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="text-neutral-300 text-sm sm:text-base leading-relaxed mb-6">
              Тобі подобається наша гра? Підтримай розробку донатом! Це допоможе нам створювати нові функції, картки та покращувати ігровий досвід. Будь-яка сума важлива! ❤️
            </p>
